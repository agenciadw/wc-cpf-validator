...
/** Plugin constants */
define( 'WC_CPF_VALIDATOR_VERSION', '0.1.1' );
...
class WC_CPF_Validator {
    ...
    private function includes() {
        ...
        require_once WC_CPF_VALIDATOR_PLUGIN_DIR . 'includes/class-wc-cpf-validator-logger.php';
    }
...
function wc_cpf_validator_activate() {
    require_once WC_CPF_VALIDATOR_PLUGIN_DIR . 'includes/class-wc-cpf-validator-settings.php';
    require_once WC_CPF_VALIDATOR_PLUGIN_DIR . 'includes/class-wc-cpf-validator-logger.php';
    WC_CPF_Validator_Logger::ensure_table();
}
register_activation_hook( __FILE__, 'wc_cpf_validator_activate' );
